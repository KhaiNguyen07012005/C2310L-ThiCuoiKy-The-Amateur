                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select class="form-select" id="inputGroupSelect01">
                                                            ...
                                                            <option value="1">ACB - 123456789000</option>
                                                            <option value="2">VIETCOMBANK - 000987654321</option>
                                                            <option value="3">MB BANK - 5678900001234</option>
                                                            <option value="4">HD BANK - 43218765000</option>
                                                        </select>
                                                    </div>

                                                    <label for="formFileMultiple" class="form-label">Vui lòng tải lên hóa đơn thanh toán</label>
                                                    <form action="{{ route('submit_payment_receipt', $order->payment) }}"
                                                        method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        <input class="form-control" placeholder="Nhập hóa đơn"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button class="btn btn-primary" type="submit">Tải lên <svg
